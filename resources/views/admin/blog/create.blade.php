    ...
    <div class="span12">
        ...
        <div class="widget blue">
            <div class="widget-title">
                <h4>
                    <i class="icon-reorder"></i> Add Blog Post
                </h4>
                <span class="tools">
            ...
            <div class="widget-body">
                <!-- BEGIN FORM-->
            <form class="form-vertical" method="POST" action="{{route('store.blogpost')}}" enctype="multipart/form-data">
                @csrf
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <input type="text" class="input-block-level" placeholder="Enter post title in english" name="post_title_en">
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <input type="text" class="input-block-level" placeholder="Enter post title in Bangla" name="post_title_ban">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                      ...
                      <div class="span12">
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                              <textarea class="span12 ckeditor" name="details_en" rows="6"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                              <textarea class="span12 ckeditor" name="details_ban" rows="6"></textarea>
                            </div>
                        </div>
                    </div>
