	...
	@endphp				
					...
					<div class="wishlist d-flex flex-row align-items-center justify-content-end">
						...
						<div class="wishlist_content">
							...
							<div class="wishlist_count"><span>{{count($wishlist )}}</span></div>
						</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Developed <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.fiverr.com/share/mm5Dwx" target="_blank">Habibur Rahman</a>
